...
import { Home, Menu, X, GraduationCap, FileText, Users, Wifi, WifiOff } from 'lucide-react';
...
export function Navigation() {
  ...
  return (
    <>
      <nav className="bg-white/90 backdrop-blur-md shadow-lg border-b border-white/20 sticky top-0 z-40 safe-top">
      ...
      {isMobileMenuOpen && (
        <div className="fixed inset-0 z-50 lg:hidden">
          ...
          <div className="fixed top-0 right-0 h-full w-80 max-w-[85vw] bg-white shadow-2xl transform transition-transform duration-300 ease-out safe-area">
