...
```bash
git remote add encore encore://student-support-ai-agent-wm2i
```
...
Monitor your deployment progress in the [Encore Cloud dashboard](https://app.encore.dev/student-support-ai-agent-wm2i/deploys).
...
2. Navigate to Encore Cloud [GitHub Integration settings](https://app.encore.cloud/student-support-ai-agent-wm2i/settings/integrations/github)
